...
export async function createWishList(params: CreateWishListParams) {
    const response = await client.post(
        '/wishlist/item/create', params.request
    )
    return response.data;
}
...
export async function updateWishlistPickStatus(params: UpdateWishlistPickStatusParams) {
    const response = await client.patch(
        `/wishlist/item/${params.itemid}/pickstatus`, params.request
    )
    return response.data;
}

// 위시리스트의 given status 변경 (자식)
export async function updateWishlistGivenStatus(params: UpdateWishlistGivenStatusParams) {
    const response = await client.patch(
        `/wishlist/item/${params.itemid}/givenstatus`, params.request
    )
    return response.data;
}
...
export async function updateWishList(params: UpdateWishListParams) {
    const response = await client.patch(
        `/wishlist/item/${params.itemid}`, params.request
    )
    return response.data;
}
