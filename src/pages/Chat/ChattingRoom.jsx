          ...
          <div className="px-4 py-5 sm:p-6">
            <div>
              ...
              <form className="flex mt-6 max-h-96" onSubmit={onSendMessage}>
                ...
                />
                <button className="whitespace-nowrap w-20 rounded-md bg-indigo-600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-indigo-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  보내기
                </button>
              </form>
            </div>
